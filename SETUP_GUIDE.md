...
- **Hutang & Kas kini tersinkron otomatis**: saat admin mencatat hutang baru, sistem otomatis membuat entri **Kas Keluar** (kategori "Piutang Anggota") sebesar nominal hutang — karena uang tersebut diambil dari kas fisik. Saat ada pembayaran hutang, sistem otomatis membuat entri **Kas Masuk** (sumber "Pembayaran Hutang Anggota") — karena uang kembali ke kas. **Catatan penting**: karena ini dua entri yang saling terhubung tapi tidak dikunci satu sama lain, sebaiknya jangan mengedit/menghapus entri Kas Masuk/Keluar yang otomatis ini secara manual dari menu Kas — itu bisa membuat saldo kas dan sisa hutang jadi tidak sinkron. Kalau perlu koreksi, sebaiknya edit langsung datanya lewat Google Spreadsheet dengan hati-hati.
